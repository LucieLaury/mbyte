          ...
          <CTableBody>
            {showParent && (
              ...
              >
                ...
                <CTableDataCell style={{ background: '#fafafa', padding: '12px 16px', verticalAlign: 'middle', lineHeight: '20px', minHeight: 56, boxSizing: 'border-box' }} className="text-end">{t('store.folder')}</CTableDataCell>
                <CTableDataCell style={{ background: '#fafafa', padding: '12px 16px', verticalAlign: 'middle', lineHeight: '20px', minHeight: 56, boxSizing: 'border-box' }} className="text-end"></CTableDataCell>
                <CTableDataCell style={{ background: '#fafafa', padding: '12px 16px', verticalAlign: 'middle', lineHeight: '20px', minHeight: 56, boxSizing: 'border-box' }} className="text-end"></CTableDataCell>
