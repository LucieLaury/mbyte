 ...
 */
@TransactionScoped
public class DummyTestTaskHandler extends TaskHandler {

    private static final Logger LOGGER = Logger.getLogger(DummyTestTaskHandler.class.getName());
    ...
    public void execute() throws TaskException {
        ...
        String helloName = getContextValue(HELLO_NAME);
        if (helloName == null) {
            this.fail("Hello Name is not set in the context");
            throw new TaskException("Missing mandatory context parameter");
        }
