 ...
 */
@QuarkusTest
public class LookupNetworkTaskTest {

    private static final Logger LOGGER = Logger.getLogger(LookupNetworkTaskTest.class.getName());

    @Inject LookupNetworkTaskHandler handler;
    ...
    public void testUnexistingNetwork() {
        ...
        context.setValue(LookupNetworkTaskHandler.NETWORK_NAME, "test_unexisting");
