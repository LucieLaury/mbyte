 ...
 */
@TransactionScoped
public class FailingTestTaskHandler extends TaskHandler {

    private static final Logger LOGGER = Logger.getLogger(FailingTestTaskHandler.class.getName());
    ...
    public void execute() throws TaskException {
        ...
        this.setGlobalContextValue(FailingTestTaskHandler.NAME, "plop");
    ...
    public void rollback() throws TaskException {
        ...
        this.unsetGlobalContextValue(FailingTestTaskHandler.NAME);
