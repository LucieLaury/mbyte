 ...
 */
@QuarkusTest
public class RemoveNetworkTaskTest {

    private static final Logger LOGGER = Logger.getLogger(RemoveNetworkTaskTest.class.getName());
    private static final String NETWORK_NAME_PREFIX = "test_remove_network_";

    @Inject RemoveNetworkTaskHandler handler;
    ...
    public void testRemoveUnexistingNetwork() throws TaskException {
        ...
        context.setValue(LookupNetworkTaskHandler.NETWORK_NAME, "unexisting");
